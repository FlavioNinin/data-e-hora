#!/bin/bash
#Script feito em 10-09-2023 para atualizar a hora do meu antigo notebook toshiba IS1413G que está com a bateria CMOS descarregada, o que impossibilita a navegação na internet.
